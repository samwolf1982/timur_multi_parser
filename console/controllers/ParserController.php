...
// сбор урлов олх по 38 штук
     ...
     */
    public function actionColecturlsolxparam($olx_count_page, $clearcash=false){
...
//                JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
    ...
    /**
     * @param bool $test_param  не нужно
     * запускать actionColecturlsolxparam * 38
     */
    public function actionParsrun($test_param=false)
    {
